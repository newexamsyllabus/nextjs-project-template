...
class GuideStep10Activity : AppCompatActivity() {

    private lateinit var adMobHelper: AdMobHelper

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_guide_step10)
        ...
        headerText.text = "Step 10"
        contentText.text = "Learn about risk management and how to protect your investments."
        progressText.text = "Page 10 of 20"
        ...
        nextButton.setOnClickListener {
            val intent = Intent(this, GuideStep11Activity::class.java)
