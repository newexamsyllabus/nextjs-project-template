...
class GuideStep9Activity : AppCompatActivity() {

    private lateinit var adMobHelper: AdMobHelper

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_guide_step9)
        ...
        headerText.text = "Step 9"
        contentText.text = "Understand the importance of diversification in your investment portfolio."
        progressText.text = "Page 9 of 20"
        ...
        nextButton.setOnClickListener {
            val intent = Intent(this, GuideStep10Activity::class.java)
