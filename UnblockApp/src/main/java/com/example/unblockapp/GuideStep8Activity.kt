...
class GuideStep8Activity : AppCompatActivity() {

    private lateinit var adMobHelper: AdMobHelper

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_guide_step8)
        ...
        headerText.text = "Step 8"
        contentText.text = "Explore different types of investments and how they can grow your wealth."
        progressText.text = "Page 8 of 20"
        ...
        nextButton.setOnClickListener {
            val intent = Intent(this, GuideStep9Activity::class.java)
