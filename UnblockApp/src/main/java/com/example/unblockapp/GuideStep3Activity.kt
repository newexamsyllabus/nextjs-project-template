...
class GuideStep3Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        headerText.text = "Step 3"
        contentText.text = "Learn how to maximize your online privacy with our easy-to-use VPN features."
        progressText.text = "Page 3 of 20"
        ...
        nextButton.setOnClickListener {
            val intent = Intent(this, GuideStep4Activity::class.java)
