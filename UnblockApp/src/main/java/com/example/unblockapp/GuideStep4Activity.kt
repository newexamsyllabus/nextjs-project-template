...
class GuideStep4Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        headerText.text = "Step 4"
        contentText.text = "Protect your data on public Wi-Fi networks with our trusted VPN service."
        progressText.text = "Page 4 of 20"
        ...
        nextButton.setOnClickListener {
            val intent = Intent(this, GuideStep5Activity::class.java)
