...
class GuideStep11Activity : AppCompatActivity() {

    private lateinit var adMobHelper: AdMobHelper

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_guide_step11)
        ...
        headerText.text = "Step 11"
        contentText.text = "Explore the benefits of long-term investing and compounding interest."
        progressText.text = "Page 11 of 20"
        ...
        nextButton.setOnClickListener {
            val intent = Intent(this, GuideStep12Activity::class.java)
